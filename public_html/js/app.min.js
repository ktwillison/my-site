...
var site = {
    init: function() {
        ...
        $( "a.show-wine-explorer" ).each(function(index) {
            $(this).on("click", site.showWineExplorer);
        });
        $( "a.show-ML-page" ).each(function(index) {
            $(this).on("click", site.showMLPage);
        });
    ...
    showMLPage: function() {
        ...
        renderMLChart();
        history.pushState('/wine-model', document.title, '/wine-model');
    },
    showWineExplorer: function() {
        ...
        renderWineExplorer();
        history.pushState('/wine-explorer', document.title, '/wine-explorer');
    },
    showHome: function() {
